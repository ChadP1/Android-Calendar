...
public class SecondActivity extends Activity {
	...
	public void onClickSendText (View v) {
		...
		if (eventNum.equals("1")) {
			...
			GregorianCalendar begDate = new GregorianCalendar(2016, 2, 28, 7, 30);
			GregorianCalendar endDate = new GregorianCalendar(2016, 2, 28, 9, 30);
		...
		if (eventNum.equals("2")) {
			...
			calIntent.putExtra(Events.EVENT_LOCATION, "Mitchell Auditorium");
			GregorianCalendar begDate = new GregorianCalendar(2016, 3, 4, 7, 30);
			GregorianCalendar endDate = new GregorianCalendar(2016, 3, 4, 9, 30);
			calIntent.putExtra(CalendarContract.EXTRA_EVENT_BEGIN_TIME,
					begDate.getTimeInMillis());
			calIntent.putExtra(CalendarContract.EXTRA_EVENT_END_TIME,
					endDate.getTimeInMillis());
		...
		if (eventNum.equals("3")) {
			...
			calIntent.putExtra(Events.EVENT_LOCATION, "Mitchell Auditorium");
			GregorianCalendar begDate = new GregorianCalendar(2016, 3, 10, 12, 30);
			GregorianCalendar endDate = new GregorianCalendar(2016, 3, 10, 2, 30);
			calIntent.putExtra(CalendarContract.EXTRA_EVENT_BEGIN_TIME,
					begDate.getTimeInMillis());
			calIntent.putExtra(CalendarContract.EXTRA_EVENT_END_TIME,
					endDate.getTimeInMillis());
